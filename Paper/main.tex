...
\titlehead{
    ...
    Supervisor: Dr. Pradhan & 07.04.2025\\ % \today zeigt jetzt das Datum auf Englisch an
    \end{tabular*}
    }
\title{Fourier Transformation Interferometry For Si, GaAs and GaSb}
...
\input{Experiment}
\input{summary}
\input{bibliography} % Manuelle Bibliographie einfügen
\input{appendix} % Anhang einfügen
\end{document}
